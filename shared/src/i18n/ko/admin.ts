...
const admin: TranslationStrings = {
  ...
  'admin.apiKeys': 'API 키',
  'admin.transitProvider': '대중교통 제공업체',
  'admin.transitProviderHint': '대중교통 경로 검색에 사용할 서비스를 선택하세요.',
  'admin.transitDefault': '(기본값)',
  'admin.navitimeKey': 'NAVITIME RapidAPI 키',
  'admin.navitimeKeyHint': '암호화되어 저장됩니다. 개인 키가 관리자 키보다 우선합니다.',
  'admin.toggleKeyVisibility': 'API 키 표시 또는 숨기기',

...
const admin: TranslationStrings = {
  ...
  'admin.transitProvider': '公共交通服务提供商',
  'admin.transitProviderHint': '选择用于搜索公共交通路线的服务。',
  'admin.transitDefault': '（默认）',
  'admin.navitimeKey': 'NAVITIME RapidAPI 密钥',
  'admin.navitimeKeyHint': '密钥将加密存储。个人密钥优先于管理员密钥。',
  'admin.toggleKeyVisibility': '显示或隐藏 API 密钥',

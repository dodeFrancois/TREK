...
const admin: TranslationStrings = {
  ...
  'admin.transit': '公共交通',
  'admin.transitProvider': '路线提供方',
  'admin.transitProviderHint': 'Transitous 免费且无需密钥。NAVITIME 覆盖日本，需要 RapidAPI 订阅。',
  'admin.navitimeKey': 'NAVITIME API 密钥',
  'admin.navitimeKeyHint': 'navitime-route-totalnavi 的 RapidAPI 密钥。选择 NAVITIME 时必填。',

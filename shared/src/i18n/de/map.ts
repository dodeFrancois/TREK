...
const map: TranslationStrings = {
  ...
  'map.search.placeholder': 'Ort auf der Karte suchen',
  'map.search.failed': 'Suche nicht verfügbar — der Geocoder hat nicht geantwortet',
  'map.search.addToTrip': 'Zur Reise hinzufügen',

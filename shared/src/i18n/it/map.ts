...
const map: TranslationStrings = {
  ...
  'map.search.placeholder': 'Cerca un luogo sulla mappa',
  'map.search.failed': 'Ricerca non disponibile — il geocoder non ha risposto',
  'map.search.addToTrip': 'Aggiungi al viaggio',

...
const map: TranslationStrings = {
  ...
  'map.search.placeholder': 'Szukaj miejsca na mapie',
  'map.search.failed': 'Wyszukiwanie niedostępne — geokoder nie odpowiedział',
  'map.search.addToTrip': 'Dodaj do podróży',

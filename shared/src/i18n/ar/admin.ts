...
const admin: TranslationStrings = {
  ...
  'admin.transitProvider': 'مزود النقل العام',
  'admin.transitProviderHint': 'اختر الخدمة المستخدمة للبحث عن مسارات النقل العام.',
  'admin.transitDefault': '(افتراضي)',
  'admin.navitimeKey': 'مفتاح NAVITIME RapidAPI',
  'admin.navitimeKeyHint': 'يُحفظ مشفرًا. يتجاوز المفتاح الشخصي مفتاح المسؤول.',
  'admin.toggleKeyVisibility': 'إظهار مفتاح API أو إخفاؤه',

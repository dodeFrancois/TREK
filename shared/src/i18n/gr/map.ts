...
const map: TranslationStrings = {
  ...
  'map.search.placeholder': 'Αναζήτηση τοποθεσίας στον χάρτη',
  'map.search.failed': 'Η αναζήτηση δεν είναι διαθέσιμη — ο geocoder δεν απάντησε',
  'map.search.addToTrip': 'Προσθήκη σε ταξίδι',

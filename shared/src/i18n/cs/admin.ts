...
const admin: TranslationStrings = {
  ...
  'admin.transitProvider': 'Poskytovatel veřejné dopravy',
  'admin.transitProviderHint': 'Vyberte službu používanou pro hledání spojení veřejnou dopravou.',
  'admin.transitDefault': '(výchozí)',
  'admin.navitimeKey': 'Klíč NAVITIME RapidAPI',
  'admin.navitimeKeyHint': 'Ukládá se šifrovaně. Osobní klíč má přednost před klíčem správce.',
  'admin.toggleKeyVisibility': 'Zobrazit nebo skrýt API klíč',

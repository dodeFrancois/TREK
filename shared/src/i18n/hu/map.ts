...
const map: TranslationStrings = {
  ...
  'map.search.placeholder': 'Hely keresése a térképen',
  'map.search.failed': 'A keresés nem érhető el — a geokóder nem válaszolt',
  'map.search.addToTrip': 'Hozzáadás utazáshoz',

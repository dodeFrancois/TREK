...
const map: TranslationStrings = {
  ...
  'map.search.placeholder': 'Rechercher un lieu sur la carte',
  'map.search.failed': "Recherche indisponible — le géocodeur n'a pas répondu",
  'map.search.addToTrip': 'Ajouter au voyage',

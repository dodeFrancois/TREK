...
const admin: TranslationStrings = {
  ...
  'admin.transit': '公共運輸',
  'admin.transitProvider': '路線提供者',
  'admin.transitProviderHint': 'Transitous 免費且無需金鑰。NAVITIME 涵蓋日本，需要 RapidAPI 訂閱。',
  'admin.navitimeKey': 'NAVITIME API 金鑰',
  'admin.navitimeKeyHint': 'navitime-route-totalnavi 的 RapidAPI 金鑰。選擇 NAVITIME 時必填。',

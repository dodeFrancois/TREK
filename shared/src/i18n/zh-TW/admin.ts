...
const admin: TranslationStrings = {
  ...
  'admin.transitProvider': '大眾運輸服務供應商',
  'admin.transitProviderHint': '選擇用於搜尋大眾運輸路線的服務。',
  'admin.transitDefault': '（預設）',
  'admin.navitimeKey': 'NAVITIME RapidAPI 金鑰',
  'admin.navitimeKeyHint': '金鑰會加密儲存。個人金鑰優先於管理員金鑰。',
  'admin.toggleKeyVisibility': '顯示或隱藏 API 金鑰',

...
const map: TranslationStrings = {
  ...
  'map.search.placeholder': 'Pesquisar um lugar no mapa',
  'map.search.failed': 'Busca indisponível — o geocodificador não respondeu',
  'map.search.addToTrip': 'Adicionar à viagem',

...
const admin: TranslationStrings = {
  ...
  'admin.transitProvider': 'Provedor de transporte público',
  'admin.transitProviderHint': 'Escolha o serviço usado para buscar rotas de transporte público.',
  'admin.transitDefault': '(padrão)',
  'admin.navitimeKey': 'Chave RapidAPI da NAVITIME',
  'admin.navitimeKeyHint': 'Armazenada com criptografia. Uma chave pessoal substitui a chave do administrador.',
  'admin.toggleKeyVisibility': 'Mostrar ou ocultar a chave de API',

...
const admin: TranslationStrings = {
  ...
  'admin.transitProvider': 'Nhà cung cấp giao thông công cộng',
  'admin.transitProviderHint': 'Chọn dịch vụ dùng để tìm tuyến giao thông công cộng.',
  'admin.transitDefault': '(mặc định)',
  'admin.navitimeKey': 'Khóa RapidAPI NAVITIME',
  'admin.navitimeKeyHint': 'Được lưu trữ mã hóa. Khóa cá nhân được ưu tiên hơn khóa quản trị viên.',
  'admin.toggleKeyVisibility': 'Hiện hoặc ẩn khóa API',

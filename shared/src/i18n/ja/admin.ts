...
const admin: TranslationStrings = {
  ...
  'admin.apiKeys': 'APIキー',
  'admin.transitProvider': '公共交通プロバイダー',
  'admin.transitProviderHint': '公共交通ルートの検索に使用するサービスを選択します。',
  'admin.transitDefault': '（デフォルト）',
  'admin.navitimeKey': 'NAVITIME RapidAPIキー',
  'admin.navitimeKeyHint': '暗号化して保存されます。個人キーは管理者キーより優先されます。',
  'admin.toggleKeyVisibility': 'APIキーを表示または非表示',

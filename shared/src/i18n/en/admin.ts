...
const admin: TranslationStrings = {
  ...
  'admin.transitProvider': 'Public transit provider',
  'admin.transitProviderHint': 'Choose the routing service used for public transit searches.',
  'admin.transitDefault': '(default)',
  'admin.navitimeKey': 'NAVITIME RapidAPI key',
  'admin.navitimeKeyHint': 'Stored encrypted. A personal key overrides the administrator key.',
  'admin.toggleKeyVisibility': 'Show or hide API key',
